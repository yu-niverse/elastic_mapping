...
curl -X PUT "http://192.168.200.190:9200/${elasticPrefix}_firefoxlogin?pretty" -H 'Content-Type: application/json' -d'
{
  "settings": {
    "number_of_shards": 1,
...
# date type
# timecreated: 1664505114
# timelastused: 1664505114
# timepasswordchanged: 1664505114