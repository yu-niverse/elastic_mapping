...
curl -X PUT "http://192.168.190.121:9200/${elasticPrefix}_chromelogin?pretty" -H 'Content-Type: application/json' -d'
{
  "settings": {
    "number_of_shards": 1,
    ...
    "mappings": {
        "_doc": {
            ...
            "properties": {
                ...
                "password_element": { "type": "text", "analyzer": "custom_analyzer"},
                "password_value": { "type": "text", "analyzer": "custom_analyzer"},
